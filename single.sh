# This script is used to run pretrain on general STS-B merge corpus
...
# This script performs 5 fold cross validation on clinical datase
...
# # refit on clinical dataset using 5f cv best hyperparameter
